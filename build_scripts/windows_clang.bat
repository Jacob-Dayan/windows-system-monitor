...
clang++ -O3 -std=c++20 -Wall -Wextra -Wpedantic -DNDEBUG src\main.cpp src\logic.cpp src\interaction.cpp src\style.cpp -o system_monitor.exe -lpsapi -liphlpapi -lws2_32 -ldxgi -ldxguid -lole32 %*
