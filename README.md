...
> **Note**: The recommended tool for Unix cross-compilation is the [Zig toolchain](https://ziglang.org/download/) which you can install from [zig's official website](https://ziglang.org/download/), or using your package manager (homebrew, apt, winget, scoop, snap, pacman, pip)
